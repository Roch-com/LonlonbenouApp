...
import { Carte, Puce, Texte } from '@/components/ui';
 ...
 *
 * Le composant porte **sa propre carte**. Auparavant l'écran d'accueil
 * l'enveloppait, si bien qu'un couple non encore relié — où ce sélecteur ne
 * rend rien — voyait une carte parfaitement vide au milieu de son accueil.
 */
